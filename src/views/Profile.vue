<template>
  <v-card class="mx-auto pa-2 mt-5 orange lighten-4" max-width="95%">
    ...
    <v-card class="text-center orange lighten-4 pa-3 mb-3" elevation="0">
      <v-list-item-subtitle
        class="font-weight-bold mt-4  d-flex justify-center title "
      >
    ...
    <v-card class="d-flex justify-center orange lighten-4" elevation="0">
      <v-list-item-subtitle
        class="font-weight-bold mt-4  d-flex justify-center"
      >
        Personal Info
      </v-list-item-subtitle>
    </v-card>
    ...
    <v-list-item two-line>
      <v-list-item-content>
        ...
        <v-list-item-subtitle class="font-weight-normal pl-4 text--primary">{{
          this.username
        }}</v-list-item-subtitle>
      </v-list-item-content>
    </v-list-item>
    ...
    <v-card
      class="mt-2 mb-2 d-flex justify-space-between orange lighten-4"
      elevation="0"
    >
