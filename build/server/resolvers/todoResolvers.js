...
var todoResolvers = /** @class */ (function () {
    ...
    assigneeURL) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Todos_1.Todos.insert({ todo: todo, house_key: house_key, date: date, victimid: victimid, creatorid: creatorid, complete: complete, assigneeURL: assigneeURL })];
                    case 1:
                        _a.sent();
    ...
    todoResolvers.prototype.updateTodoVictim = function (id, victimid, assigneeURL) {
        return __awaiter(this, void 0, void 0, function () {
            var todoToBeUpdated;
            return __generator(this, function (_a) {
                switch (_a.label) {
